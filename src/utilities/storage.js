...
export const storage = {
    ...
    /** 
    `set token(value)` is a setter function that sets the value of the local storage item with
    ...
    */
    ...
    /* `get token()` is a getter function that returns the value of the local storage item with
